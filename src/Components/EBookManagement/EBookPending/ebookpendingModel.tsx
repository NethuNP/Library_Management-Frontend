...
interface EBookpendingModelProps {
  isOpen: boolean;
  onClose: () => void;
...
const EBookpendingModel: React.FC<EBookpendingModelProps> = ({
  isOpen,
  onClose,
  selectedBook,
  handleApprove,
  ...
  const approveAndClose = async (id: string) => {
    try {
      // Call the approve function and await its success
...
export default EBookpendingModel;
